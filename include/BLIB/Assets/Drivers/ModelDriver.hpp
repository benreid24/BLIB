...
public:
     ...
     */
    virtual bool doCreate(const as::CreateContext& ctx, ModelPayload& payload) override;
     ...
     * @return True on success, false on failure
     */
    virtual bool doRead(const as::ReadContext& ctx, ModelPayload& payload) override;
     ...
     * @return True on success, false on failure
     */
    virtual bool doWrite(const as::WriteContext& ctx, const ModelPayload& payload) override;
};
