...
public:
     ...
     */
    virtual bool doCreate(as::CreateContext& ctx, SoundPayload& payload) override;
     ...
     * @return True on success, false on failure
     */
    virtual bool doRead(as::ReadContext& ctx, SoundPayload& payload) override;
     ...
     * @return True on success, false on failure
     */
    virtual bool doWrite(as::WriteContext& ctx, const SoundPayload& payload) override;
};
