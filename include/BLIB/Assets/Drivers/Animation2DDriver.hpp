...
public:
     ...
     */
    virtual bool doCreate(const as::CreateContext& ctx, Animation2DPayload& payload) override;
     ...
     * @return True on success, false on failure
     */
    virtual bool doRead(const as::ReadContext& ctx, Animation2DPayload& payload) override;
     ...
     * @return True on success, false on failure
     */
    virtual bool doWrite(const as::WriteContext& ctx, const Animation2DPayload& payload) override;
};
