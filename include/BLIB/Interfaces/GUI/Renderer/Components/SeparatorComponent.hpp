#ifndef BLIB_GUI_RENDERER_COMPONENTS_SEPARATORCOMPONENT_HPP
#define BLIB_GUI_RENDERER_COMPONENTS_SEPARATORCOMPONENT_HPP
...
{
/**
 * @brief Default component type for Separator elements
 *
 * @ingroup GUI
 */
class SeparatorComponent : public rdr::Component {
public:
    /**
     ...
     */
    virtual ~SeparatorComponent() = default;
