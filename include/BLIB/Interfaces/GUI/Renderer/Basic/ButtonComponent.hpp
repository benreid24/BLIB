#ifndef BLIB_GUI_RENDERER_COMPONENTS_BUTTONCOMPONENT_HPP
#define BLIB_GUI_RENDERER_COMPONENTS_BUTTONCOMPONENT_HPP
...
{
/**
 * @brief Default component type for Button elements
 *
 * @ingroup GUI
 */
class ButtonComponent : public rdr::Component {
public:
    /**
