#ifndef BLIB_GUI_RENDERER_COMPONENTS_ICONCOMPONENT_HPP
#define BLIB_GUI_RENDERER_COMPONENTS_ICONCOMPONENT_HPP
...
{
/**
 * @brief Default component type for Icon elements
 *
 * @ingroup GUI
 */
class IconComponent : public rdr::Component {
public:
    /**
