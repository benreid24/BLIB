#ifndef BLIB_GUI_RENDERER_COMPONENTS_SELECTBOXCOMPONENT_HPP
#define BLIB_GUI_RENDERER_COMPONENTS_SELECTBOXCOMPONENT_HPP
...
{
/**
 * @brief Default component type for SelectBox elements
 *
 * @ingroup GUI
 */
class SelectBoxComponent : public rdr::Component {
public:
    /**
     ...
     */
    virtual ~SelectBoxComponent() = default;
