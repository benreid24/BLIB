#ifndef BLIB_GUI_RENDERER_COMPONENTS_IMAGECOMPONENT_HPP
#define BLIB_GUI_RENDERER_COMPONENTS_IMAGECOMPONENT_HPP
...
{
/**
 * @brief Default component type for Image elements
 *
 * @ingroup GUI
 */
class ImageComponent : public rdr::Component {
public:
    /**
