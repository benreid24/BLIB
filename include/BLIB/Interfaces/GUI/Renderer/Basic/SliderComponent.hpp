#ifndef BLIB_GUI_RENDERER_COMPONENTS_SLIDERCOMPONENT_HPP
#define BLIB_GUI_RENDERER_COMPONENTS_SLIDERCOMPONENT_HPP
...
{
/**
 * @brief Default component type for Slider elements
 *
 * @ingroup GUI
 */
class SliderComponent : public rdr::Component {
public:
    /**
     ...
     */
    virtual ~SliderComponent() = default;
