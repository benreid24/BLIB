#ifndef BLIB_RENDER_BUFFERS_INTERFACES_BINDABLEBUFFERDOUBLESOURCED_HPP
#define BLIB_RENDER_BUFFERS_INTERFACES_BINDABLEBUFFERDOUBLESOURCED_HPP
...
public:
     ...
     */
    BindableBufferDoubleSourced() = default;

    /**
     * @brief Destroys the buffers
     */
    virtual ~BindableBufferDoubleSourced() = default;
