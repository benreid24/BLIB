...
{
template<>
struct hash<bg::parser::Node::Sequence> {
    size_t operator()(const bg::parser::Node::Sequence& key) const {
...
inline bool operator==(const bg::parser::Node::Sequence& rhs,
                       const bg::parser::Node::Sequence& lhs) {
