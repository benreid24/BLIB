...
void bl::gfx::ds::Object2DInstance::bindForPipeline(VkCommandBuffer, VkPipelineLayout,
                                                    std::uint32_t, std::uint32_t) const {
    // noop
}

void bl::gfx::ds::Object2DInstance::bindForObject(VkCommandBuffer commandBuffer,
