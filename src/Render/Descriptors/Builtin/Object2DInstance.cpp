...
void Object2DInstance::releaseObject(ecs::Entity entity, scene::Key) {
...
bool Object2DInstance::doAllocateObject(ecs::Entity entity, scene::Key key) {
...
void Object2DInstance::beginSync(DirtyRange dirtyStatic, DirtyRange dirtyDynamic) {
