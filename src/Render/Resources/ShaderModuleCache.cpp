...
VkShaderModule ShaderModuleCache::loadShader(const std::string& path) {
    ...
    if (path[1] == '\0') {
        ...
        case cfg::ShaderIds::ShadowVertexSkinned[0]:
            return loadShader(BUILTIN_SHADER("3D/Shadows/shadowMapSkinned.vert.spv"));
        case cfg::ShaderIds::PointShadowVertex[0]:
            return loadShader(BUILTIN_SHADER("3D/Shadows/pointShadowMap.vert.spv"));
        case cfg::ShaderIds::PointShadowVertexSkinned[0]:
            return loadShader(BUILTIN_SHADER("3D/Shadows/pointShadowMapSkinned.vert.spv"));
        ...
        case cfg::ShaderIds::SSAOBlurFragment[0]:
            return loadShader(BUILTIN_SHADER("3D/SSAO/blur.frag.spv"));
        case cfg::ShaderIds::SSAOGenFragment[0]:
            return loadShader(BUILTIN_SHADER("3D/SSAO/gen.frag.spv"));
        case cfg::ShaderIds::SSAOGenResolveFragment[0]:
            return loadShader(BUILTIN_SHADER("3D/SSAO/genResolve.frag.spv"));
        case cfg::ShaderIds::SSAOGenSampledFragment[0]:
            return loadShader(BUILTIN_SHADER("3D/SSAO/genSampled.frag.spv"));
